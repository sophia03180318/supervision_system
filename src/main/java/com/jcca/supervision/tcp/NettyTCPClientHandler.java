 ...
 * @author: sophia
 */
public class NettyTCPClientHandler extends SimpleChannelInboundHandler<DataBaseInfo> {

    private Logger logger = LoggerFactory.getLogger(NettyTCPClientHandler.class);

    private NettyTCPClient nettyTCPClient;

    public NettyTCPClientHandler(NettyTCPClient nettyTCPClient) {
