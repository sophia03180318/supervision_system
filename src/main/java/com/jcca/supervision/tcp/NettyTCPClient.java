...
public class NettyTCPClient {
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel ch) {
                        ch.pipeline()
                                ...
                                .addLast(new NettyTCPClientHandler(NettyTCPClient.this));
                    }
                });
    }
    ...
    public void connect() {
        ...
        try {
            ...
            channelFuture.addListener(new NettyTCPConnListener(NettyTCPClient.this));
            Channel channel = channelFuture.channel();

            DataConst.TEMP_MAP.put(DataConst.NETTY_TCP_CHANNEL, channel);

            channel.closeFuture().sync();
        } catch (Exception e) {
            logger.error("[{}]-[TCP客户端连接关闭]", IdUtil.getSnowflakeNextIdStr());
        }
    }
